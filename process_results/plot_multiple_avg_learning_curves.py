...
perf_files = [('../simulations/Gridworld/with_advice/arch_3/importance/adv_limit_10/2e-2/rewards_statistics.npy', 'imp_2e-2'),
              ('../simulations/Gridworld/with_advice/arch_3/importance/adv_limit_10/1e-2/rewards_statistics.npy', 'imp_1e-2'),
              ('../simulations/Gridworld/with_advice/arch_3/crit/adv_limit_10/rewards_statistics.npy', 'crit'),
